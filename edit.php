    ...
    ?>
		<form method="post" action="update.php">
			<table>
                ...
                <td>
                <select name="kelas">
					<option value="pilih" <?php echo active_radio_button("pilih", $d['kelas'])?>>pilih</option>
                    <option value="TI-1A" <?php echo active_radio_button("TI-1A", $d['kelas'])?>>TI-1A</option>
                    <option value="TI-1B" <?php echo active_radio_button("TI-1B", $d['kelas'])?>>TI-1B</option>
                    <option value="TI-1C" <?php echo active_radio_button("TI-1C", $d['kelas'])?>>TI-1C</option>
                    <option value="TI-1D" <?php echo active_radio_button("TI-1D", $d['kelas'])?>>TI-1D</option>
                </select>
                </td>
			    </tr>
				<tr>
