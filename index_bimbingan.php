...
include 'sidebar.php';//Untuk membuat Sidebar
  ?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a class="btn btn-success" href="tambah_bimbingan.php">TAMBAH</a>
          ...
          ?>
             <tr>
              ...
              <td>
                 ...
                 <a href="hapus_bimbingan.php?id_bimbingan=<?php echo $d['id_bimbingan']; ?>" class="btn btn-danger alert_notif">HAPUS</a>
               </td>
             </tr>
             <?php 
           }
